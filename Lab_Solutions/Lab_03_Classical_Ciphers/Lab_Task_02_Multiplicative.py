# Task 2: Multiplicative Cipher

# Function to find modular inverse
# modular math: “What number x, when multiplied with a, gives remainder 1 after dividing by m?”
def mod_inverse(a, m):
    a = a % m
    for x in range(1, m):
        if (a * x) % m == 1:
...
# ---------------- Example ----------------
key = 7  # Must be coprime with 26 because 26 = 2 * 13, what it means is that key should not be divisible by 2 or 13
